...
**60 AI tools that know every X++ class, table, form, and EDT in your D365FO codebase**
...
|-----------------|-----------|------------|
| [Quick Start](docs/QUICK_START.md) — 5 steps to running | [All 60 tools](docs/MCP_TOOLS.md) | [Azure deployment](docs/SETUP_AZURE.md) |
